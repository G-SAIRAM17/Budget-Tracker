...
def calendarToday(request):
    if request.user.is_authenticated:
        ...
        # Print current time in IST for debugging
        print(now_ist)
        # Extract date components in IST
        d1 = now_ist.strftime("%d")  # Day of the month
        d2 = now_ist.strftime("%m")  # Month
        d3 = now_ist.strftime("%Y")  # Year
        
        # Redirect to the calendar view with IST date components
